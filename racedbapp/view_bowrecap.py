...
def index(request, bow_slug, phase):
    ...
    full_results = []
    namedfullresult = namedtuple('na', ['athlete', 'category', 'stages', 'total_time',           
    ...
    for athlete in athletes:                                                     
        ...
        if stages == int(phase):
            full_results.append(namedfullresult(athlete, category, stages, total_time, total_seconds,   
                                                stage_times))                                 
    ...
    namedresult = namedtuple('nr', ['category', 'female_athlete', 'female_time',
                                    'male_athlete', 'male_time'])
    results = []
    ...
    results.append(namedresult('Overall', female_leader.athlete.name, female_leader.total_time, male_leader.athlete.name, male_leader.total_time))
    results.append(namedresult('Masters', masters_female_leader.athlete.name, masters_female_leader.total_time, masters_male_leader.athlete.name, masters_male_leader.total_time))
