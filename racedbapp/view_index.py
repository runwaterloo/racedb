...
named_future_event = namedtuple('nfe', ['event',
                                        'race',
                                        'distance',
                                        'records',
                                        'team_records',
...
def get_future_events():
    ...
    for i in dbfuture_events:
        ...
        records = False
        if numresults > 0:
            records, team_records, hill_records = view_shared.getracerecords(i.race, i.distance)
        future_events.append(named_future_event(event, race, distance, records, team_records, hill_records))
