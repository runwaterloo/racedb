test_urls = (
    # no longer actively used, this requires complete production data to run
    ...
    "/boost/2018/?member=robert-brouillette",
    # /bow
    "/bow/bow-i/",
    ...
    "/endurrace/latest/",
    "/endurrace/2015/",
    "/endurrace/2014/?filter=Male" "/endurrace/2013/?filter=Masters",
