...
def get_pb_badges(member, results):
            ...
            if not tenk_pb:
                ...
                if r.result.guntime < tenk_pb.guntime:
                    ...
                    if tenk_minutegroup:
                        ...
                        tenk_minutegroup = new_minutegroup
    if fivek_minutegroup:
        image = utils.get_achievement_image(member.gender.lower(), f"5-km-{fivek_minutegroup}")
        pb_badges.append(
            named_badge(
    ...
    if tenk_minutegroup:
        image = utils.get_achievement_image(member.gender.lower(), f"10-km-{tenk_minutegroup}")
        pb_badges.append(
            named_badge(
